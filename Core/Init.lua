...
function SUI:OnInitialize()
    ...
    function self:Skin(frame, customColor, isTable, color, desaturated)
        local forbiddenFrames = {
            ...
            [select(1, QuestLogDetailFrame:GetRegions())] = true,
        }

        if (CompactRaidFrameManagerDisplayFrameLeaderOptionsRaidWorldMarkerButton) then 
            forbiddenFrames[select(12, CompactRaidFrameManagerDisplayFrameLeaderOptionsRaidWorldMarkerButton:GetRegions())] = true
        end

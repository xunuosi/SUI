local Module = SUI:NewModule("ActionBars.Retail");
...
function Module:OnEnable()
	...
	if (db.style == 'BFA' and db.module) then
		-- Get Player class
		...
		function Update_StatusBars()
			-- Reputation bar Font
			ReputationWatchBar.OverlayFrame.Text:SetFont("Fonts\\ARHei.TTF", 10, "OUTLINE")
			...
			-- Experience bar Font
			MainMenuBarExpText:SetFont("Fonts\\ARHei.TTF", 10, "OUTLINE")
